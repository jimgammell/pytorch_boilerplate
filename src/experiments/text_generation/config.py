...
class Config:
    ...
    arm_kwargs: Dict[str, Any] = field(default_factory=dict)
    ...
    def __post_init__(self):
        ...
        self.arm_kwargs['pretrained_gpt2_size'] = self.pretrained_gpt2_size
        self.arm_kwargs['pretrained_model_path'] = self.pretrained_arm_path
